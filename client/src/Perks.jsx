...
export default function Perks({ selected, onChange }) {
  ...
  return (
    <>
      <label className="border p-2 flex rounded-xl gap-1 items-center cursor-pointer">
      ...
      <label className="border p-2 flex rounded-xl gap-1 items-center cursor-pointer">
        <input type="checkbox" checked={selected.includes('clim')} name="clim" onChange={handleCbClick} />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
