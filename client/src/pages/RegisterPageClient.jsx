...
export default function RegisterPageClient() {
  ...
  async function registerClient(ev) {
    ev.preventDefault();

    try {
      await axios.post("/registerClient", {
        nom,
        prenom,
        email,
        password,
    ...
    <div className="p-5 grow">
      ...
      <div className="mt-4">
        <h1 className="mb-12 font-sans text-3xl font-bold text-center">
          Bienvenue sur <br /> YachtHaven
        </h1>
        <form className="max-w-xs mx-auto" onSubmit={registerClient}>
          <label>Email*</label>
          <input
            className="mb-14"
            type="email"
        ...
        <div className="max-w-xs mx-auto mb-20 text-center">
          <h2 className="mb-6 text-xl font-bold">Deja membre ?</h2>
